...
function getDominantColor(imagePath) {
    return __awaiter(this, void 0, void 0, function () {
        var image, width, height, colorMap, y, x, _a, r, g, b, colorKey, maxCount_1, dominantColor_1, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    for (y = 0; y < height; y++) {
                        for (x = 0; x < width; x++) {
                            _a = Jimp.intToRGBA(image.getPixelColor(x, y)), r = _a.r, g = _a.g, b = _a.b;
                    ...
                    maxCount_1 = 0;
                    dominantColor_1 = "";
                    colorMap.forEach(function (count, color) {
                        if (count > maxCount_1) {
                            maxCount_1 = count;
                            dominantColor_1 = color;
                        }
                    });
                    return [2 /*return*/, {
                            rgp: dominantColor_1,
                            hexa: rgbToHex(dominantColor_1.split(",")[0], dominantColor_1.split(",")[1], dominantColor_1.split(",")[2]),
                        }];
                case 2:
                    error_1 = _b.sent();
